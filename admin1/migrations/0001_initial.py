    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartitem', to='admin1.cart')),
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin1.food')),
            ],
        ),
        migrations.CreateModel(
            name='Offer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='admin1.food')),
        ...
        migrations.AddField(
            model_name='cart',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cart', to='admin1.customer'),
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('vendors', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin1.vendor')),
            ],
        ),
    ]
